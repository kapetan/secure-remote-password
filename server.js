...
exports.generateEphemeral = function (verifier, { N, g, k, hashOutputBytes }) {
  // v    Password verifier
  const v = SRPInteger.fromHex(verifier)

  // B = kv + g^b             (b = random number)
  const b = SRPInteger.randomInteger(hashOutputBytes)
...
exports.deriveSession = function (serverSecretEphemeral, clientPublicEphemeral, salt, username, verifier, clientSessionProof, { N, g, k, H }) {
